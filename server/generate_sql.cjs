...
BEGIN
    ...
    INSERT INTO credenciales (idempleado, username, user_password) VALUES (emb1, 'admin', '${hashedPass}') ON CONFLICT (username) DO NOTHING;
    INSERT INTO credenciales (idempleado, username, user_password) VALUES (emb2, 'juan.perez', '${hashedPass}') ON CONFLICT (username) DO NOTHING;
    INSERT INTO credenciales (idempleado, username, user_password) VALUES (emb3, 'maria.lopez', '${hashedPass}') ON CONFLICT (username) DO NOTHING;
    INSERT INTO credenciales (idempleado, username, user_password) VALUES (emb4, 'carlos.ruiz', '${hashedPass}') ON CONFLICT (username) DO NOTHING;
    INSERT INTO credenciales (idempleado, username, user_password) VALUES (emb5, 'roberto.gomez', '${hashedPass}') ON CONFLICT (username) DO NOTHING;
    INSERT INTO credenciales (idempleado, username, user_password) VALUES (emb6, 'pedro.sanchez', '${hashedPass}') ON CONFLICT (username) DO NOTHING;
    INSERT INTO credenciales (idempleado, username, user_password) VALUES (emb7, 'empleado.prueba', '${hashedPass}') ON CONFLICT (username) DO NOTHING;
END $$;
  `;

  fs.writeFileSync('../populate_erp.sql', sql.trim(), 'utf8');
  console.log('Script SQL generado exitosamente en populate_erp.sql');
}
